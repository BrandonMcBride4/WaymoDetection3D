...
def visualize_batch_input(batch, colors={0:'r',1:'b',2:'g'}, num = 0):
  visualize_ground_truth(batch['gt_label'][num],batch['point_cloud'][num],batch['foreground'][num],batch['voxels'][batch['voxels'][:,0]==num],batch['gt_reg'][num],batch['gt_class'][num],batch['gt_dir'][num],colors)
  plt.show()
